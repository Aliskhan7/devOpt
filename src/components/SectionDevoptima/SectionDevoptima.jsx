...
function SectionDevoptima() {
    return (
        <div className='flex justify-between items-center gap-x-20 py-32'>
            ...
            <div>
                <h2 className='text-white text-5xl font-light mb-5'>What is DevOptima?</h2>
                <p className='text-gray-200 text-xl font-thin'>At DevOptima, we are a team of
                    passionate DevOps experts committed to transforming the way businesses approach software development and operations.</p>
                <div className='mt-12 grid grid-cols-2 grid-rows-2 gap-x-24 gap-y-10'>
                    {
                        dataDev.map(data =>{
                            return (
                                <div>
                                    <Image className='mb-3' src={data.icon} width={50} height={50} alt='icon'/>
                                    <h4 className='text-white text-xl font-medium mb-2'>{data.title}</h4>
